...
class OrderSecuredScreen extends StatefulWidget {
  const OrderSecuredScreen({super.key});

  @override
  State<OrderSecuredScreen> createState() => _OrderSecuredScreenState();
}

class _OrderSecuredScreenState extends State<OrderSecuredScreen> {
            ...
            SafeArea(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Spacer(),
                    // Custom Flutter Success Animation
